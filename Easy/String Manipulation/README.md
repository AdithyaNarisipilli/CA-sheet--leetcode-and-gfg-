<h2><a href="https://practice.geeksforgeeks.org/problems/string-manipulation3706/1?page=1&difficulty[]=0&category[]=Stack&sortBy=submissions">String Manipulation</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><div class="starwars-lab">
